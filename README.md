...
Images, Sounds 폴더를 포함하여 레포지토리를 전체 다운로드 받은 후, 솔루션 또는 프로젝트 파일을 열어서 main.cpp를 실행해주시면 됩니다.

bangtal 라이브러리를 읽지 못하여 빌드 오류가 발생하는 경우, 비주얼 스튜디오 창 상단에서 개발 환경이 x86(32비트)플랫폼으로 설정되어 있는지 확인해주시길 바랍니다.
